...
const Navbar = () => {
  ...
  return (
    <>
        <header className={
            !navState ? 'absolute top-7 left-0 right-0 opacity-100 z-50' : 'fixed top-0 left-0 right-0 h-[9vh] flex items-center justify-center opacity-100 z-[101] blur-effect-theme'
        }>
            <nav className='flex items-center justify-between nike-container'>
                ...
                <ul className='flex items-center justify-center gap-2'>
                    <li className='grod items-center'>
                    ...
                    <li className='grod items-center'>
                        <button type='button' onClick={onCartToggle} className='border-none outline-none active:scale-110 transition-all duration-300 relative'><ShoppingBagIcon className={`icon-style ${navState && 'text-slate-900 transition-all duration-300'}`}/>
